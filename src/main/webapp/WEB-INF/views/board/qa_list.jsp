							...
							<tbody class="xans-element- xans-board xans-board-notice-1002 xans-board-notice xans-board-1002 notice">
								<c:forEach var="vo" items="${list1}">
									<tr class="xans-record-">
										...
										<td class="subject"><a href="${pageContext.request.contextPath}/board/qa_detail?no=${vo.no}&txt=${param.txt}&page=${param.page}" style="color: #000000;">
										${vo.title}
										<c:if test="${vo.repcnt > 0 }">
											<span style="color: red;">(${vo.repcnt})</span>
										</c:if>
										</a> 
						...
						<div class="btnArea ">
							...
							<span class="right">
								<security:authorize access="isAuthenticated()">
									<a href="${pageContext.request.contextPath}/board/qa_write" class="ec-base-button bts3 ">write</a>
								</security:authorize>
							</span>
						</div>
					...
					.twbsPagination(
							{
								...
								onPageClick : function(event, page) {
									window.location.href = "${pageContext.request.contextPath}/board/qa_list?txt="
											+ '${param.txt}' + "&page=" + page;
								}
							});
		});
