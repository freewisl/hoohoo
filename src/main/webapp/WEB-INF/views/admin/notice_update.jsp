		...
		<div id="container">
			...
			<div id="contents">
				...
				<div class="xans-element- xans-board xans-board-readpackage-1002 xans-board-readpackage xans-board-1002 ">
					...
					<!-- 글 내용-->
					<form id="BoardWriteForm" action="${pageContext.request.contextPath}/admin/notice_update" method="post">
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
						<div class="xans-element- xans-board xans-board-read-1002 xans-board-read xans-board-1002">
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<input name="title" class="inputTypeText" type="text" required="required" value="${vo.title}"/>
											</td>
										</tr>
										<tr>
											<th scope="row">writer</th>
											<td><input name="writer" class="inputTypeText" type="hidden" value="${vo.writer}"/>
											${vo.writer}</td>
										</tr>
										<tr class="view">
											<td colspan="2">
												<div class="detail">
													<div class="fr-view fr-view-article">
														<textarea class="form-control" rows="20" cols="100" wrap="hard" name="content" style="background-color: white; width: 96.7%; resize: none;">${vo.content}</textarea>
													</div>
												</div>
											</td>
										</tr>
							...
							<div class="btnArea ">
								<span class="left">
									<input type="button" class="ec-base-button bts3 w" value="list" onclick="location.href='${pageContext.request.contextPath}/board/notice?txt=${param.txt}&page=${param.page}'"/>
								</span> 
								<span class="right"> 
